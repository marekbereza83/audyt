...
2. **Ton: merytoryczny, nigdy obraźliwy.** Fakt → konsekwencja → rozwiązanie — **ale tylko w raporcie `audyt.md`**. W `mail-fragment.txt` (i całym cold mailu) trójtakt nie obowiązuje: obserwacja kończy się na obserwacji + jedno pytanie otwarte, bez zdania konsekwencji i bez zdania rozwiązania. Szczegóły w `SKILL.md` → Krok 5.
